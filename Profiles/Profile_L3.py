...
def Profile_L3(param="fNH3",profile="Meridional",ProfileHalfWidth=45,
    ...
    PTG.plot_profile_L3(axsavgprof,"SCT 2022",ProfileHalfWidth=ProfileHalfWidth,
                        LatPlotLims=LatPlotLims,ZonePlotHalfWidth=ZonePlotHalfWidth,
                        profile=profile,clr='k',width=1.5,param=param,smooth=smooth)
    PTG.plot_profile_L3(axsavgprof,"VLTMUSE 2022",ProfileHalfWidth=ProfileHalfWidth,
                        LatPlotLims=LatPlotLims,ZonePlotHalfWidth=ZonePlotHalfWidth,
                        profile=profile,clr='k',width=1.5,param=param,smooth=smooth,
                        style='dashed')
    PTG.plot_profile_L3(axsavgprof,"SCT 2023",ProfileHalfWidth=ProfileHalfWidth,
                        LatPlotLims=LatPlotLims,ZonePlotHalfWidth=ZonePlotHalfWidth,
