def Profile_L2(band="NH3",profile="Meridional",ProfileHalfWidth=45,
    ...
    #!!!!!!!! NEED BETTER FILE NAMING CONVENTION FOR OUTPUT FILES!!
    ...
    LatsSCT20,OutProSCT20,OutStdSCT20=PTG.plot_profile_L2(axsavgprof,"2020 CMOS",ProfileHalfWidth=ProfileHalfWidth,
                        LatPlotLims=LatPlotLims,ZonePlotHalfWidth=ZonePlotHalfWidth,
                        profile=profile,clr='C0',width=1.0,band=band,smooth=smooth)
    LatsSCT21,OutProSCT21,OutStdSCT21=PTG.plot_profile_L2(axsavgprof,"2021 CMOS",ProfileHalfWidth=ProfileHalfWidth,
                        LatPlotLims=LatPlotLims,ZonePlotHalfWidth=ZonePlotHalfWidth,
