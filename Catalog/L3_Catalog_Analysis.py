def L2_Catalog_Analysis(writecsv=False,writejson=False,plothist=False):
    """
    ...
    if writejson:
        filename="C:/Astronomy/Projects/SAS 2021 Ammonia/Jupiter_NH3_Analysis_P3/Catalog/L2FITS.json"
        with open(filename, "w") as fp:
            json.dump(sourcefiles , fp) 
    print("TEST0")

    if writecsv or plothist:
        filename="C:/Astronomy/Projects/SAS 2021 Ammonia/Jupiter_NH3_Analysis_P3/Catalog/L2FITS.csv"
    ...
    if plothist:
        ...
        filename="C:/Astronomy/Projects/SAS 2021 Ammonia/Jupiter_NH3_Analysis_P3/Catalog/L2FITSHist.png"
