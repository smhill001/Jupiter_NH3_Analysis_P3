...
The file naming convention is: YYYY-MM-DD-HHMM_S-Jupiter_PARAME_SX_CX_SysX_CMXXX.fits,
where:
    ...
    - SX represents a smoothing boolean where SM indicates smoothing of the
      ...
      has not been done.
    - CX represents a smoothing boolean where SM indicates smoothing of the
      input transmission data has been done and S0 indicates smoothing
      has not been done.
