def TestContiguousMap(collection="20230815-20230818"):
    """
    ...
    elif collection=="20230815-20230818 Blend":
        dataset={'20230815UTa',
                 '20230816UTa',
                 '20230817UTa',
                 '20230818UTa'}
        
        lonlims={'20230815UTa':[120,195],
                 '20230816UTa':[256,360],
                 '20230817UTa':[40,140],
                 '20230818UTa':[200,300]}
    ...
    elif collection=="20231015-20231019 Blend":
        dataset={'20231015UTa',
                 '20231015UTb',
                 '20231017UTa',
                 '20231017UTb',
    ...
    elif collection=="20231022-20231026 Blend":
        dataset={'20231022UTa',
                 '20231023UTa',
                 '20231023UTb',
                 '20231024UTa',
    ...
    elif collection=="20231112-20231113 Blend":
        dataset={'20231112UTa',
                 '20231112UTb',
                 '20231113UTa',
                 '20231113UTb'}
        
        lonlims={'20231112UTa':[272,360],
                 '20231112UTb':[290,360],
                 '20231113UTa':[0,90],
                 '20231113UTb':[10,110]}
    ...
    elif collection=="20231115-20231115 Blend":
        dataset={'20231115UTa',
                 '20231115UTb'}
        
        lonlims={'20231115UTa':[325,360],
                 '20231115UTb':[340,360]}
    ...
    elif collection=="20231128-20231129 Blend":
        dataset={'20231128UTa',
                 '20231128UTb',
                 '20231129UTa',
                 '20231129UTb',
    ...
    elif collection=="20231206-20231207 Blend":
        dataset={'20231206UTa',
                 '20231206UTb',
                 '20231207UTa',
                 '20231207UTb',
    ...
    elif collection=="20231217-20231218 Blend":
        dataset={'20231217UTa',
                 '20231217UTb',
                 '20231217UTc',
                 '20231218UTa',
    ...
    elif collection=="20231229-20231229 Blend":
        dataset={'20231229UTa',
                 '20231229UTb',
                 '20231229UTc'}
        
        lonlims={'20231229UTa':[0,110],
                 '20231229UTb':[60,150],
                 '20231229UTc':[110,200]}
    ...
    elif collection=="20240129-20240202 Blend":
        dataset={'20240129UTa',
                 '20240129UTb',
                 '20240130UTa',
                 '20240130UTb',
    ...
    elif collection=="20240229-20240301 Blend":
        dataset={'20240229UTa',
                 '20240229UTb',
                 '20240301UTa',
                 '20240301UTb'}
    ...
    fig1,axs1=pl.subplots(3,1,figsize=(6.0,6.0), dpi=150, facecolor="white",
    ...
    for ix in range(0,2):
        ...
        axs1[ix].set_yticks(np.linspace(-60,60,9), minor=False)
    ...
    axs1[2].set_xlabel("Sys. 2 Longitude (deg)",fontsize=9)
    ...
    fig1.savefig(pathmapplots+collection+"map.png",dpi=300)
