def ZonalHSTWinds(HSTkey1,HSTkey2):
    ...
    pathHST='C:/Astronomy/Projects/SAS 2021 Ammonia/Data/HST OPAL/'
...
def NEZ_feature_quiver_plot():
    """
    Plot average speed and average location for each feature tracked over the 
    apparition. Two plots are produced, one with relative longitude and one
    with absolute longitude.
    ...
    fig.savefig(pathmapplots+"Speed and Relative Location.png",dpi=300)
    fig1.savefig(pathmapplots+"Speed and Sys 1 Location.png",dpi=300)
