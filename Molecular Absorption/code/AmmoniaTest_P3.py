...
fig_ray.savefig(projpath+pathout+'Trns_v_Pres_RaySub'+fout_sfx+'.png',dpi=320,bbox_inches = 'tight')
fig_raycont.savefig(projpath+pathout+'Wght_v_Pres_RaySub'+fout_sfx+'.png',dpi=320,bbox_inches = 'tight')
...
filtereffectivedata = open(projpath+pathout+'filtereffectivedataMod3.csv', 'w')
